...
public class EntregaController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<EntregaModelDTO> buscar(@PathVariable Long id){
...
//			entregaModelDto.setDestinatario(new DestinatarioModelDTO());
...
//			entregaModelDto.setDataFinalizacao(entrega.getDataFinalizacao());
